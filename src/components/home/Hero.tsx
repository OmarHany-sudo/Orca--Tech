      ...
      <div className="container mx-auto px-4 py-20 flex flex-col md:flex-row items-center">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6">
            Web Development & Cybersecurity Solutions
          </h1>
          <p className="text-xl text-gray-200 mb-8">
            High-quality websites, secure systems, and performance-driven
            solutions.
          </p>
          ...
          <div className="relative">
            <div className="w-80 h-60 bg-gray-800 rounded-xl shadow-2xl overflow-hidden border-2 border-orca-blue relative">
              ...
              <div className="p-4 text-orca-blue font-mono text-xs space-y-1">
                ...
                <div>{'};'}</div>
                <div className="text-light-blue mt-2">console.log('OrcaTech');</div>
              </div>
            </div>
            <motion.div
              animate={{ y: [0, -10, 0] }}
